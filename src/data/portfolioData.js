...
export const PROJECTS = [
    {
    icon: "📝",
    title: "AI Powered Document ChatBot",
    desc: "Built a Retrieval-Augmented Generation (RAG) chatbot capable of answering user queries from uploaded PDF and text documents using Large Language Models (LLMs).",
    tags: ["LLM", "Langchain", "Ollama", "FastAPI"],
    metric: "RAG",
  },
  {
    icon: "⚡",
